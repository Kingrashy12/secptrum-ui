...
import BasicSwitch from "@/components/example/inputs/switch/Basic";
import DisabledSwitch from "@/components/example/inputs/switch/DisabledSwitch";
import SwitchSizes from "@/components/example/inputs/switch/Size";
import SwitchColors from "@/components/example/inputs/switch/SwitchColors";
