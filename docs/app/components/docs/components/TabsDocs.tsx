...
import BasicTabs from "@/components/example/navigation/tabs/BasicTabs";
import DisabledTab from "@/components/example/navigation/tabs/DisabledTab";
import FullWidthTabs from "@/components/example/navigation/tabs/FullWidthTabs";
import SolidVariantTabs from "@/components/example/navigation/tabs/SolidTabs";
import TabsWithIcons from "@/components/example/navigation/tabs/TabsWithIcon";
