...
import { LangCodeTabs } from '@/components/custom/docs/LangCodeTabs';
    ...
    <>
      ...
      <Box direction="column" spacing="md" id="initialize-registry">
        ...
        <DocText>
          ...
          your project and add it to src/lib/registry.js or src/lib/registry.tsx
        </DocText>
      </Box>
      <Box direction="column" spacing="md" id="import-registry">
        ...
        <Box direction="column" spacing="md" marginTop="lg">
          <Tabs variant="solid">
            ...
            <TabPanel>
              <CodeBlock code={next_setup.page_setup.tsx} />
            </TabPanel>
            <TabPanel>
              <CodeBlock code={next_setup.page_setup.js} />
            </TabPanel>
          </Tabs>
        </Box>
      </Box>
      ...
      <Box direction="column" spacing="md" id="implementation">
        ...
        <LangCodeTabs
          tsCode={next_setup.page_setup.mode_tsx}
          jsCode={next_setup.page_setup.mode_js}
        />
      </Box>
      <Box
        direction="column"
      ...
      >
        ...
        <LangCodeTabs
          tsCode={next_setup.page_setup.use_mode_tsx}
          jsCode={next_setup.page_setup.use_mode_js}
        />
      </Box>
      <Box direction="column" spacing="md" id="single-mode">
        ...
        <LangCodeTabs
          tsCode={next_setup.page_setup.single_mode_tsx}
          jsCode={next_setup.page_setup.single_mode_js}
        />
      </Box>
    </>
  );
