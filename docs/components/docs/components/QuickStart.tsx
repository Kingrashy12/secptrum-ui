...
import Usage from "../../example/quick-start/Usage";
import UsingStyled from "../../example/quick-start/UsingStyled";
import UsingTailwind from "../../example/quick-start/UsingTailwind";
